...
const SudokuCell = memo(function SudokuCell(props: CellProps) {
  ...
  const bg = isSelected
    ? 'rgba(220, 13, 29, 0.10)'
    : isSameNumber && !isSelected && value !== 0
      ? 'rgba(220, 13, 29, 0.06)'
      : isInUnit
        ? 'rgba(212, 201, 181, 0.04)'
        : 'transparent';
    ...
    <button
      ...
      style={{
        ...
        borderRight: thickRight
          ? '1.5px solid rgba(212, 201, 181, 0.4)'
          : '1px solid rgba(212, 201, 181, 0.1)',
...
export default function SudokuGrid(props: Props) {
  ...
  return (
    <div
      className="relative grid grid-cols-9 grid-rows-9 aspect-square w-full bg-[#0f0f0f] border border-[rgba(212,201,181,0.4)] rounded-rp-md overflow-hidden"
      role="grid"
